...
function initializeDataTableforLetters() {
    const lettersTable = $('#letters-table').DataTable({
        ...
        "initComplete": function () {
            attachRowClickListener(lettersTable);
        }
    });
}
...
function attachRowClickListener(lettersTable) {
    ...
    $('#letters-table tbody').off('click', 'tr').on('click', 'tr', function () {
    ...
    $('#letters-table tbody').off('click', 'button').on('click', 'button', function (e) {
